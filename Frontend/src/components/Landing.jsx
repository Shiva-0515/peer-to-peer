...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
          ...
          {!isLoggedIn && (
            <div className="hidden md:flex items-center gap-6">
              ...
              <button
                ...
                className="border border-gray-300 bg-blue-500 text-white rounded-md px-4 py-2 text-sm hover:bg-blue-600 transition"
              >
                Login
              </button>
          ...
          {isLoggedIn && (
            <div className="hidden md:flex items-center gap-6">
              ...
              <button
                ...
                className="border border-gray-300 bg-blue-500 rounded-md px-4 py-2 text-sm text-white hover:bg-blue-600 transition"
              >
                Logout
              </button>
            </div>
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-br from-gray-100 via-white to-gray-50 text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="mt-16 grid grid-cols-3 gap-8 max-w-2xl mx-auto">
            ...
            <div>
              <div className="text-3xl font-bold text-green-600 mb-1">1 GB</div>
      ...
      {/* --- The rest of your component stays 100% unchanged --- */}

      {/* Features, About, CTA, Footer... */}
      {/* (Keeping everything as-is for you) */}
      ...
      <section id="about" className="py-20 lg:py-32 bg-gradient-to-br from-gray-50 via-white to-gray-100">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6 border border-amber-200 rounded-lg p-6">
